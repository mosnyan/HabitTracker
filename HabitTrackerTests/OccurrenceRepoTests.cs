...
public class OccurrenceRepoTests
{
    ...
    {
        _habitRepo.CreateHabit(new Habit(0, "test", "tests"));
        Occurrence occ = new(0, "2025-07-14 10:30:00", 1);
    ...
    {
        _habitRepo.CreateHabit(new Habit(0, "test", "tests"));
        _habitRepo.CreateHabit(new Habit(0, "test2", "tests"));
        Occurrence occ1 = new(0, "2025-07-14 10:30:00", 1);
        _occRepo.CreateOccurrence(occ1);
        Occurrence occ2 = new(0, "2025-07-14 10:30:01", 1);
        _occRepo.CreateOccurrence(occ2);
        Occurrence occ3 = new(0, "2025-07-14 10:30:00", 2);
